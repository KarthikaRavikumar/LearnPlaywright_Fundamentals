...
test.describe("URL & title  Assertions - TestingAcademy", () => {
  test("URL & title assertions", async ({ page }) => {
    await page.goto(
      "https://app.thetestingacademy.com/playwright/widgets/calendar.html",
    );
    await page.getByTestId("trigger-depart").click();
    await expect(page).toHaveTitle(
      "Calendar Date Picker — The Testing Academy",
    );
    await expect(page).toHaveURL(
      "https://app.thetestingacademy.com/playwright/widgets/calendar",
    );
