...
1. id -> #idValue
2. class -> .classValue
3. attribute -> [attributeName='value']
4. combination -> tag#idValue.classValue[attributeName='value']

XPath Selector to CSS Selector
1. //tag[@attribute='value'] -> tag[attribute='value'] -> Remove // and @

contains -> *
startes with -> ^
ends with -> $
direct child -> a > input
any depth decendent -> from input
*/
